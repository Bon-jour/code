...
def Runspades(indir,outdir,sample_info_dic):
    ...
    for line in open(sampleinfo):
        if not line.startswith("sample"):
            ...
            cmd =f' /root/miniconda3/envs/metadoc/bin/metaspades.py -1 {indir}/{line[0]}/{line[0]}_1_kneaddata_paired_1.fastq \
            -2 {indir}/{line[0]}/{line[0]}_1_kneaddata_paired_2.fastq \
